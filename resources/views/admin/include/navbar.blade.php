 <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li>
          <a class="app-menu__item active" href="{{url('admin')}}"
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a class="treeview-item" href="{{url('bootstrapElement')}}"
            ...
            <li>
              <a class="treeview-item" href="{{url('cards')}}"
                ><i class="icon fa fa-circle-o"></i> Cards</a
              >
            </li>
            <li>
              <a class="treeview-item" href="{{url('widgets')}}"
        ...
        <li>
          <a class="app-menu__item" href="{{url('charts')}}"
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a class="treeview-item" href="{{url('formComponent')}}"
                ><i class="icon fa fa-circle-o"></i> Form Components</a
              >
            </li>
            <li>
              <a class="treeview-item" href="{{url('formCoustom')}}"
                ><i class="icon fa fa-circle-o"></i> Custom Components</a
              >
            </li>
            <li>
              <a class="treeview-item" href="{{url('formSample')}}"
                ><i class="icon fa fa-circle-o"></i> Form Samples</a
              >
            </li>
            <li>
              <a class="treeview-item" href="{{url('formNotification')}}"
